...
public class Spawner : MonoBehaviour
{
    ...
    public GameObject MissilePrefabs;                   //미사일 프리팹을 선언 한다.
    ...
    [Header("스폰 타이밍 설정")]
    public float minSpawnlInterval = 0.5f;              //최소 생성 간격(초)
    ...
    {
        nextSpawnTime = Random.Range(minSpawnlInterval, maxSpawnInterval);  //최소-최대 사이의 랜덤한 시간 설정
    }
